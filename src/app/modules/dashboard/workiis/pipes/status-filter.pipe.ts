...
export class StatusFilterPipe implements PipeTransform {
  transform(workiis: (IWorkii & WorkiiInfo)[], selectedStatus: string[], applications: readonly IApplicationUser[] | null, userCurrentId: string): (IWorkii & WorkiiInfo)[] | undefined {
